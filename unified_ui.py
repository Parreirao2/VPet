...
class SimpleSettingsWindow:
    ...
    def _update_pet_color(self, color):
        ...
        if hasattr(self.pet_manager, 'animation') and hasattr(self.pet_manager.animation, 'handle_color_change'):
            ...
            # Restore direction if it was saved
    ...
    def save_pet(self):
        ...
        if success:
            ...
            # Refresh the save files list if we have a reference to the listbox
    ...
    def load_pet(self, filename):
        """Load pet from selected save file"""
        if not filename:
    ...
    def show_notification(self, title, message, color):
        ...
        # SimpleSettingsWindow doesn't have panel_window attribute, so use self.window or self.parent
...
class ModernSettingsWindow(SimpleSettingsWindow):
    """Settings window with modern styling"""
